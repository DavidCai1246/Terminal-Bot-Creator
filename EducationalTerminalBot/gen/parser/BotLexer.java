// Generated from C:/Qsync/UBC/yr4/CS410/Project1Group21/EducationalTerminalBot/src/parser\BotLexer.g4 by ANTLR 4.10.1
package parser;
...
public class BotLexer extends Lexer {
	...
	public static final int
		...
		INPUT_WS=32;
	public static final int
		TEXT_MODE=1, INPUT_MODE=2;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "TEXT_MODE", "INPUT_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"DECLARE", "USE_CUSTOM", "EXCLAMATION_MARK", "STORE", "AS", "IF", "IS", 
			"THEN", "ELSE", "INCREASE", "DECREASE", "SET", "KEEP", "UNTIL", "PRINT", 
			"NEXT", "GENERATE_RANDOM_NUMBER_BETWEEN", "AND", "BY", "HAS_USER_INPUT", 
	...
	@Override
	public String getGrammarFileName() { return "BotLexer.g4"; }
